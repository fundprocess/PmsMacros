...
var discretionaryPortfolioTypeStream = ProcessContextStream
    .Select($"{TaskName}: Create internal portfolios classification type", ctx => new SecurityClassificationType { Code = "InternalPortfolioClassificationType", 
...
FileStream.WaitWhenDone($"{TaskName}: wait till targetInstrumentStream is saved", targetInstrumentStream);
