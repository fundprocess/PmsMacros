...
//
var tstClassificationType = ProcessContextStream.EfCoreSelect("Get tst classification type", (ctx, j) => ctx
...
var classificationsOfSecurity = ProcessContextStream.EfCoreSelect("Get every security", (ctx, j) => ctx
